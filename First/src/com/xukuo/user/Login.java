...
public class Login extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<!DOCTYPE html>\n" +
                ...
                "            <form action='Index' method=\"post\" class=\"rightform\">\n" +
                "                <input type=\"text\" name=\"userphone\" placeholder=\"请输入手机号\"><br>\n" +
                "                <input type=\"password\" name=\"userpassword\" placeholder=\"请输入密码\"><br>\n" +
                "                <button type=\"submit\" class=\"btn btn-success\">登录</button><button type=\"submit\" class=\"btn btn-success\" onclick=\"form.action='"+contextPath+"/Register"+"'\">注册</button>\n" +
                "            </form>\n" +
